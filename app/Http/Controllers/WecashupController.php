...
class WecashupController extends Controller
{
    ...
    public function payment(Request $request)
    {
        ...
        $validatedRequest = [
            ...
            'transaction_provider_name' => 'required',
            'transaction_confirmation_code' => 'required',
        ];
        $merchant_uid = '7QAYWgNsBwgb26euVhALY3plibF3';
        $merchant_public_key = 'pk_live_0HMFbSda1I5HNc6d';
        $merchant_secret = 'sk_live_uAlgXAn13ZDOgsvVtvRumjQMKeaVphr4mOhFnc6c9Koh';
