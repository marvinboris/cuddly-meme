...
@parent
    ...
    <div id="browse-workerss" class="section bg-gray">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12 order-1 order-lg-2">
                    <div class="img-thumb">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 order-2 order-lg-1">
                    <div class="text-wrapper">
                        <div class="pt-3">
                            <h4 class="d-none d-sm-block">Search talents</h4>
                            <p class="lead text-dark">
    ...
    <div id="pricing" class="section bg-gray">
        <div class="container">
            <div class="section-header">
                ...
                <p class="lead text-dark">Single pricing plan to rule them all</p>
            </div>
