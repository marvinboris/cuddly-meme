                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="horz-layout-colored-controls">Edit user {{ $user->first_name }}</h4>
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    <div class="card-text">
                                        <p> Fill the form above to update user, fields with <code>*</code> are required.</p>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" class="form-control" value="{{ $user->first_name }}" required placeholder="First Name" name="first_name">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input class="form-control" required type="tel" value="{{ $user->phone }}" name="phone" inputmode="tel" placeholder="Phone number">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <textarea id="userinput8" rows="5" required class="form-control" name="specialization" placeholder="User specialization">{{ $user->specialization }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="custom-file">
                                                                ...
                                                                <label class="custom-file-label" for="inputGroupFile01">
                                                                    @if($user->pic)
                                                                        Leave if you don't want to change
                                                                    @else
                                                                        Choose video file
                                                                    @endif
                                                                </label>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="custom-file">
                                                                ...
                                                                <label class="custom-file-label" for="inputGroupFile01">Leave if you don't want to change</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
